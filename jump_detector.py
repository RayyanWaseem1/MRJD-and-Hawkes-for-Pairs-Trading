...
class JumpDetector:
    ...
    def extract_jump_times(self, jump_df: pd.DataFrame) -> np.ndarray:
        ...
        jump_times_numeric = (jump_times - start_time).days + (jump_times - start_time).seconds / (24 * 3600)
...
if __name__ == "__main__":
    ...
    output_path = os.path.join(output_dir, 'jump_detection_test_xom_cvx.png')
