...
class TradingSignals:
    ...
    def __init__(self,
        ...
        self._percentiles_frozen = False #True when set from a training bundle
    ...
    def set_lambda_percentiles(self, percentiles: dict):
        """ 
        Freeze lambda percentiles computed on training data. 

        When set, generate_signals will skip recomputing percentiles from the evaluation-period intensity,
        ensuring regime thresholds stay anchored to the training distribution (no look-ahead).
        """
    ...
    def generate_signals(self,
        ...
        # Calculate λ percentiles for regime classification
        # Skip if percentiles were frozen from a training period
